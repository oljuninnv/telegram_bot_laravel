...
php artisan serve
```
2. Перейдите по ссылке ngrok под пунктом Web Interface, дополните её /inspect/http для отслуживания ответов бота
...
#### 1. Добавление чата в базу данных
  ...
  - Если чат отсутствует, он добавляется в таблицу chats с указанием.
...
## Заключение
Теперь вы готовы к использованию бота и всего его функционалом. Спасибо за внимание!